...
import com.stock.gateway.security.AuthoritiesConstants;
import com.stock.gateway.security.SecurityUtils;
import com.stock.gateway.security.oauth2.AudienceValidator;
import com.stock.gateway.security.oauth2.JwtGrantedAuthorityConverter;
import com.stock.gateway.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        .and()
            ...
            .pathMatchers("/services/*/api/employees/get-user-by-pinfl/*").permitAll()
            .pathMatchers("/services/*/api/application/*").permitAll()
