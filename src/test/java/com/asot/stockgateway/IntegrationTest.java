...
import com.asot.stockgateway.ReactiveSqlTestContainerExtension;
import com.asot.stockgateway.StockGatewayServiceApp;
...
@SpringBootTest(classes = { StockGatewayServiceApp.class, TestSecurityConfiguration.class })
